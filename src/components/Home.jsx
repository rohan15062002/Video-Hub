import { Box, Container, Heading, Image, position, Stack, Text, textDecoration,VStack } from '@chakra-ui/react';
...
const MyCarousel=()=>(
    ...
    >
     <Box w="full" h={'100vh'}>
        <Image src={img1} alt="Image1"  h="full" w={'full'} objectFit={'cover'}/>
     ...
     <Box w="full" h={'100vh'}>
        <Image src={img2} alt="Image1" h="full" w={'full'} objectFit={'cover'}/>
        <Heading bgColor={'blackAlpha.600'} color={'white'} {...headingOptions}>
        Future is Gaming
        </Heading>
     </Box>
     ...
     <Box w="full" h={'100vh'}>
        <Image src={img3} alt="Image1" h="full" w={'full'} objectFit={'cover'}/>
        <Heading bgColor={'blackAlpha.600'} color={'white'} {...headingOptions}>
        Gaming on Console
        </Heading>
     </Box>
     ...
     <Box w="full" h={'100vh'}>
        <Image src={img4} alt="Image1" h="full" w={'full'} objectFit={'cover'}/>
        <Heading bgColor={'blackAlpha.600'} color={'white'} {...headingOptions}>
        Night life is cool
        </Heading>
     </Box>
